...
pub enum VirtualKey {
    ...
    Apps = 0x5D,
    Sleep = 0x5F,
    #[serde(rename = "num_pad0")]
    NumPadZero = 0x60,
    #[serde(rename = "num_pad1")]
    NumPadOne = 0x61,
    #[serde(rename = "num_pad2")]
    NumPadTwo = 0x62,
    #[serde(rename = "num_pad3")]
    NumPadThree = 0x63,
    #[serde(rename = "num_pad4")]
    NumPadFour = 0x64,
    #[serde(rename = "num_pad5")]
    NumPadFive = 0x65,
    #[serde(rename = "num_pad6")]
    NumPadSix = 0x66,
    #[serde(rename = "num_pad7")]
    NumPadSeven = 0x67,
    #[serde(rename = "num_pad8")]
    NumPadEight = 0x68,
    #[serde(rename = "num_pad9")]
    NumPadNine = 0x69,
    Multiply = 0x6A,
    Add = 0x6B,
    Separator = 0x6C,
